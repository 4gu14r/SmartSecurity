...
<html>
    ...
    <body>
        ...
        <form method="post" action="../controller/cadastrarCelularUsuarioController.php">
            <p><label>Marca:</label></p>
                    <select required="" name="marca" id="marca"> 
                        ...
                        <label for="marcasoutras">Outra Marca?</label><input class="inpOc" type="checkbox" name="marcasoutras" id="marcasoutras" onClick="HabilDesabOutrasMarcas()"><br><input type="text" name="marcasoutras" id="outrasmarcas" disabled="" placeholder="Qual Marca?">
                        <br>
