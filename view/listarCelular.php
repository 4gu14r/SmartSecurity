...
svg{
    ...
    <body>
        ...
        foreach ($listaCelulares as $celular) {
            ...
            echo "<td>";
            echo "<a href='../view/formAlterarCelular.php?cod={$celular['cod']}'>";
            echo "<button class='btn alterar'>";
            echo"Alterar";
            echo "</button>";
            echo"</a>";
            echo"<a href='../controller/excluirCelularByCodController.php?cod={$celular['cod']}'>";
            ?>
        <button class="btn excluir" onclick="confirm('Deseja remover esse aparelho?')">Excluir</button>
            <?php
            echo"</a>";
            echo "<a href='../view/buscaCelular.php?cod={$celular['cod']}'>";
            echo "<button class='btn buscar'>";
            echo"buscar";
            echo "</button>";
            echo"</a>";
            echo"</td>";
