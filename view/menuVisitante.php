...
<html>
    <head>
        <meta charset="UTF-8">
        <title></title>
        <link href="../css/menuVisitante.css" rel="stylesheet" type="text/css"/>
        ...
        <header id="cabecalho">
            <div class="menu">
                ...
                <ul id="principal">
                    ...
                    <li><a href="estatisticaVisitante.php">Estatísticas</a></li>
                    <br><br><br><br>
            ...
            <form name="searchform"  method="post" action="../view/menuVisitante.php">
