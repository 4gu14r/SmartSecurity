...
<html>
    ...
    <body>
        <div>
            <form name="formuser" method="post" action="../controller/alterarUsuarioController.php" style="margin-top: 0px">
                ...
                <fieldset><legend>Sexo</legend>
                    <?php
                    if("sexo"=="masc"){
                        echo "<label for='masc' >Masculino</label><input type='radio' name='sexo' id='masc' value='Masculino' checked='' class='inpOc'>"
                        . "<label for='femi'><label>Feminino</label><input type='radio' name='sexo' id='femi' value='Feminino' class='inpOc'>";
                    }else{
                        echo "<label for='masc' >Masculino</label><input type='radio' name='sexo' id='masc' value='Masculino' checked='' class='inpOc'>"
                        . "<label for='femi'><label>Feminino</label><input type='radio' name='sexo' id='femi' value='Feminino' class='inpOc'>";
                    }
                ...
                <label for="Administrador">Administrador</label> <input class="inpOc" type="radio"
                                             <?php
                                                if ($usuario["perfil_cod"]==1) echo "cheked";
                                             ?>
                                                                        name="perfil" id="Administrador" value="1"/>
                        
                <label for="Usuario">Usuário</label> <input class="inpOc" type="radio"
                                            <?php
                                                if ($usuario["perfil_cod"]==2) echo "cheked";
                                             ?>
                                                            name="perfil" id="Usuario" value="2"/>
                <br><br>
