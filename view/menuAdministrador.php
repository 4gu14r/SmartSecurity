...
<html>
    <head>
        <meta charset="UTF-8">
        <title></title>
        <link href="../css/menuAdministrador.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        <header id="cabecalho">
            <div class="menu">
                ...
                <nav>
                    <ul id="principal">
                        <p style="color: white; position: absolute; top: 40px; left: 200px;">
                            <?php
                        ...
                        <li><a href="minhasOcorrencias.php">Minha Ocorrências</a></li>
                        ...
                        <li><a style="cursor: pointer; color: whitesmoke;">Configuração</a>
                            <ul id="submenu">
                                ...
                                <li><a href="listarOcorrencia.php">Listar Ocorrência</a></li>
                                <li><a href="listarCelular.php">Listar Celular</a></li>
