...
<html>
    ...
    <body>
        ...
        <form method="post" action="../controller/alterarMinhasOcorrenciasController.php"style="margin-top: 0;">
            ...
            <fieldset>
                ...
                if("tipo"=="Perda"){
                    echo "<label for='perda'> Perda </label><input class='inpOc' type='radio' name='tipo' id='perda' value='Perda'>"
                    . "<label for='assalto'> Assalto </label><input class='inpOc' type='radio' name='tipo' id='assalto' value='Assalto'>";
